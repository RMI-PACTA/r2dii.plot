...
The `plot_*()` functions show the data as they are and allow you to customize by:
* using their parameters, 
* modifying the input (for example, by adding a column 'label' or 'label_tech' 
for changing the data labels) 
