...
We recognize users and developers have different preferences. Here is how the
APIs compare across a number of criteria relevant to them:
...
knitr::kable(users, caption = "User's perspective.")
...
knitr::kable(devs, caption = "Developer's perspective.")
```
