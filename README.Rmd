...
trajectory. For each kind, you'll need to subset the specific rows you want to
plot. For details see the documented "Requirements" of the argument `data` of
each `plot_*()` function (e.g. see `?plot_emission_intensity`). If you forget to
...
* `plot_trajectory()` outputs a basic plot that you may want to polish, for
