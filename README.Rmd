...
helps you customize your plots. Here, we'll use example dataset that comes with 
r2dii.plot and that resembles the output of
[`target_market_share()`](https://2degreesinvesting.github.io/r2dii.analysis/reference/target_market_share.html) function in the r2dii.analysis package. (For more examples
of data sets and plots please visit [Get started with r2dii.plot](https://2degreesinvesting.github.io/r2dii.plot/articles/articles/r2dii-plot.html).)
