# works with custom `additional_line_metrics` and brown technology
    ...
    Output
      ...
      $layers
      $layers[[1]]
      mapping: x = ~year, ymin = ~.data$value_low, ymax = ~.data$value, group = 1 
      geom_ribbon: na.rm = FALSE, orientation = NA, outline.type = both
      stat_identity: na.rm = FALSE
      position_identity 
      
      $layers[[2]]
      mapping: x = ~year, y = ~.data$value 
      ...
      List of 93
       ...
       $ plot.margin               : 'simpleUnit' num [1:4] 0.5cm 0.5cm 0.5cm 0.5cm
        ..- attr(*, "unit")= int 1
...
# works with `annotate_data`
    ...
    Output
      ...
      $layers[[2]]
      mapping: x = ~x, xend = ~xend, y = ~y, yend = ~yend 
      ...
      $layers[[5]]
      mapping: x = ~year, y = ~.data$value_low 
      geom_line: na.rm = FALSE, orientation = NA
      stat_identity: na.rm = FALSE
      position_identity 
